...
class UnifiedStegoApp:
    def __init__(self, root):
        self.root = root
        self.root.title("ESTEGANOGRAFIA LSB CODIFICAR - LSB DECODIFICAR - ESTEGO AVANÇADO")
    ...
    def _build_header(self):
        ...
        tk.Label(header, text="ESTEGANOGRAFIA LSB CODIFICAR - LSB DECODIFICAR - ESTEGO AVANÇADO",
