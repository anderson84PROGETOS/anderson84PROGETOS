...
root = tk.Tk()
root.title("Tools Website Graphic")
...
url_entry = tk.Entry(frame, width=35, font=("Arial", 11))
url_entry.pack(padx=3, pady=(0, 5))  # Espaçamento inferior de 10 pixels
...
result_text = scrolledtext.ScrolledText(root, wrap=tk.WORD, width=120, height=45, font=("Arial", 12))
