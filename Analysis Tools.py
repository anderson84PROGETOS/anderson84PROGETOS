...
input_frame.grid(column=0, row=0, columnspan=2, padx=5, pady=1)
...
buttons = [
    ...
    ("3 = Consulta Whois", "3"),
    ("4 = Transferência de Zona DNS", "4"),
    ("5 = Exibir IPv4", "5"),
    ("6 = Exibir robots.txt", "6"),
    ("7 = Scraper Web", "7")
]
...
result_frame.grid(column=0, row=7, columnspan=2, padx=2, pady=2)
