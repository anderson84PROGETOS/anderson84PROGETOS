...
def construir_consulta_dork(site_nome, dork_selecionada):
    consultas = {
        ...
        #Adicione outras consultas aqui conforme necessário
...
def obter_dados_google_hacking():
    ...
    try:
        ...
        resultado_completo = f"\nsite:{site_nome} {dork_selecionada}\n\n\n{consulta}\n\n\n\n\n\n\n{resultado}"
...
instrucoes_label = Label(dorks_frame, text="Por favor, selecione uma Dork do Google", font=("Arial", 12))
