...
def get_address_info():
    ...
    if response.status_code == 200:
        ...
        regiao_response = requests.get(regiao_url, verify=False)
        ...
        if location:
            ...
            longitude_label.config(text="Impossível obter localização do CEP")
        ...
        cidade_label.config(text="")        
        latitude_label.config(text="")
        longitude_label.config(text="Impossível obter informações do CEP")
