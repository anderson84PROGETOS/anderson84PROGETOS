...
def obter_whois_br(endereco):
    ...
    if resultado.strip():  # Verifica se a resposta não está vazia
        ...
        print(Fore.LIGHTRED_EX + "Nenhuma informação encontrada para o domínio.")
...
def consulta_whois():
    endereco = input(Fore.LIGHTMAGENTA_EX + "Digite o IP ou Nome do website Para Consultar WHOIS: ").strip()
