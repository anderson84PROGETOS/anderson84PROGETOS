...
import requests  # Added for macvendors.com API
...
class NetworkMonitorApp:
    def __init__(self, parent):
        ...
        # Botões (usando customtkinter)
        self.refresh_button = ctk.CTkButton(
            self.main_frame,
            text="Atualizar Conexões",
            command=self.list_connections,
            fg_color="#00FF00",
            hover_color="#32CD32",
        ...
        self.exe_path_button = ctk.CTkButton(
            self.main_frame,
            text="Mostrar Caminho do Executável",
            command=self.show_exe_path,
            fg_color="#00f2ff",
            hover_color="#05b2fc",
            font=("Helvetica", 12, "bold"),
            text_color="black"
        ...
        self.copy_path_button = ctk.CTkButton(
            self.main_frame,
            text="Copiar Caminho do Executável",
            command=self.copy_exe_path,
            fg_color="#f8fc05",
            hover_color="#c1c406",
            font=("Helvetica", 12, "bold"),
            text_color="black"
        ...
        try:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    return "Rate Limited (macvendors.com)"
                else:
                    return "Desconhecido"
...
class WiFiScannerApp:
    ...
    def __init__(self, parent):
        ...
        exit_button = ctk.CTkButton(
            button_frame,
            text="Sair",
            command=self.main_frame.winfo_toplevel().quit,
            fg_color="#f44336",
            hover_color="#d32f2f",
            font=("Arial", 12),
            text_color="black"
                        ...
                        try:
                            ...
                            try:
                                ...
                                if response.status_code == 200:
                                    ...
                                    fabricante = "Rate Limited (macvendors.com)"
                                else:
...
class MainApp:
    def __init__(self, root):
        ...
        self.root.after(100, lambda: self.root.wm_state('zoomed'))  # Maximizar no Windows
        ...
        self.menu_frame.grid(row=0, column=0, sticky="ew", pady=1)
        ...
        ctk.CTkButton(
            ...
            command=self.load_network_monitor,
            fg_color="#4CAF50",
            hover_color="#388E3C",
            font=("Arial", 12),
            text_color="black"
        ...
        ctk.CTkButton(
            ...
            command=self.load_network_scanner,
            fg_color="#2196F3",
            hover_color="#1976D2",
            font=("Arial", 12),
            text_color="black"
        ...
        ctk.CTkButton(
            self.menu_frame,
            text="Wi-Fi Scanner",
            command=self.load_wifi_scanner,
            fg_color="#fa9405",
            hover_color="#e65100",
            font=("Arial", 12),
            text_color="black"
        ...
        # Container for apps
        self.app_container = ctk.CTkFrame(self.root, fg_color="#1e1e1e")
