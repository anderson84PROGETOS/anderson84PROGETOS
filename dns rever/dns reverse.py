                ...
                if "Nome:" in output:
                    ...
                    for line in lines:
                        if "Nome:" in line:
                            ...
                            align_width = 60 if record_type == 'A' else 60
                            align_width = 60  # ou outro número que funcione bem para seus domínios
...
def main():
    ...
    if ip:
        print(Fore.LIGHTMAGENTA_EX + Style.BRIGHT + f"{exchange:<45} IP:  {ip}")
