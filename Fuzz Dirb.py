...
def main():
    ...
    wordlist_url = 'https://github.com/anderson84PROGETOS/anderson84PROGETOS/raw/meu-progetos/common.txt'
    
    # Baixar o wordlist
    words = download_wordlist(wordlist_url)
    
    if not words:
        print("\nOcorreu um problema ao baixar o arquivo 'common.txt'.")
        return
