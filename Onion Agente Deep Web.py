...
def search_subdomains():
    ...
    for i, subdomain in enumerate(subdomains):
        ...
        result_text.tag_configure("red", justify="left", font=('TkDefaultFont', 12, 'bold'), foreground='#910707')
...
title_label = ttk.Label(window, text='Onion Agente Deep Web', font=('TkDefaultFont', 14, 'bold'))
title_label.pack(side=tk.TOP, anchor='w', padx=10, pady=10)
bold_font = font.Font(weight='bold')

url_label = tk.Label(window, text='Digite o Nome do site ou a URL do website (ex: google.com ou https://google.com)', padx=12, font=bold_font)
# Adjust the padx value as needed
url_label.pack(side=tk.TOP, anchor=tk.W, padx=210)

clear_all_button = tk.Button(window, text='Clean All', command=clear_text, padx=5, pady=5, bg='#f50a0a', fg='black', font=('TkDefaultFont', 11, 'bold'))
...
search_button = tk.Button(window, text='Search', command=search_subdomains, padx=15, pady=1, bg='#05f7eb', fg='black', font=('TkDefaultFont', 11, 'bold'))
