...
class Application:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🔎 IP Real | 📧 MX | 🌍 Geo | 🌐 WHOIS | 📋 CIDR | 🔗 HTTX Scanner")
    ...
    def setup_aba1(self):
        ...
        self.progress1 = ttk.Progressbar(aba1, orient="horizontal", length=600, mode="determinate")
    ...
    def setup_aba4(self):
        ...
        self.notebook.add(aba4, text="🚀 HTTX Scanner")

        tk.Label(aba4, text="🚀 HTTX Scanner - Fuzzer + Scanner de IP (Portas customizáveis)", 
                 font=("Arial", 16, "bold")).pack(pady=10)
        ...
        self.ua_combo = ttk.Combobox(ua_frame, width=80, state="readonly")
        ...
        # Progresso
        self.progress = ttk.Progressbar(aba4, length=1100, mode="determinate")
