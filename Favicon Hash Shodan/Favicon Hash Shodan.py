...
class FaviconFinderApp:
    def __init__(self, root):
        ...
        self.root.title("Favicon Hash Shodan")
        ...
        self.search_button = tk.Button(root, text="Buscar favicon Shodan", command=self.find_favicons, font=("TkDefaultFont", 10, "bold"), bg='#0cf27b')
        self.search_button.pack(pady=5)

        self.save_button = tk.Button(root, text="Salvar Informações", command=self.save_to_file, font=("TkDefaultFont", 10, "bold"), bg='#07eff7')
