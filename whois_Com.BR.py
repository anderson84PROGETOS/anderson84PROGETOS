...
entry = Entry(window, width=40, font=("TkDefaultFont", 10, "bold"))
entry.pack(pady=10)

# Create a button to initiate the Whois lookup
button = Button(window, text="Whois (.COM)", command=obter_whois, bg="#6495ED", font=("TkDefaultFont", 10, "bold"))
button.pack(pady=5)
...
text_box = Text(window, height=100, width=150, font=("TkDefaultFont", 10, "bold"))
