...
janela = tk.Tk()
janela.title("Gerenciador de Variáveis de Ambiente")
...
# Título
lbl(janela, "GERENCIADOR DE VARIÁVEIS DE AMBIENTE", VERDE, ("Arial", 16, "bold")).pack(pady=(12, 2))
...
btn(frame_escolha, "ESCOLHER PROGRAMA", escolher_prog, AZUL, 20).pack(side="left", padx=6)
btn(frame_escolha, "ESCOLHER PASTA", escolher_pasta, "#5c6bc0", 18).pack(side="left", padx=6)
...
btn(frame_b, "ADICIONAR", adicionar, "#00a86b", 14).pack(side="left", padx=4)
btn(frame_b, "MOSTRAR VALOR", mostrar_var, "#e79b0d", 14).pack(side="left", padx=4)
btn(frame_b, "LISTAR TODAS", listar, CINZA, 14).pack(side="left", padx=4)
btn(frame_b, "REMOVER ENTRADA", lambda: remover_entrada(), "#d32f2f", 16).pack(side="left", padx=4)

tk.Button(frame_b, text="LIMPAR CONSOLE",
