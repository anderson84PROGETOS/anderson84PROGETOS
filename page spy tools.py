...
# User agents para simular requisições feitas pelo navegador Firefox e cURL
...
# Cabeçalhos padrão para Firefox e cURL
headers_firefox = {
...
# Função para verificar o website
def website_check(url, headers):
    try:
        response = requests.get(url, headers=headers)
        print("\n\n🎯============================== website check ==========================🎯\n")
        print(response.text)
...
7 = Scraper Web
8 = Website Check ==> [Exemplo de uso]: http://businesscorp.com.br/config
...
0 = Sair
        ...
        if choice == '1':
            ...
            website_check(url, headers_firefox)
        elif choice == '0':
            break
        else:
