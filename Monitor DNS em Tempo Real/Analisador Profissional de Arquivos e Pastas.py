...
class FileSizeViewer:
    ...
    def create_widgets(self):
        ...
        self.search_entry.bind(
            "<Return>",
            lambda e: self.filter_items()
        )

        # ================= STATUS =================
        self.status_var = tk.StringVar(
            value="Selecione uma Pasta para começar"
        )
        ...
        # força aparecer barra horizontal
        ...
        self.menu.add_command(
            label="Abrir Pasta do Item",
            command=self.open_item_folder
        )
    ...
    def filter_items(self):
        ...
        for item in self.all_items:
            ...
            if (
                ...
                search_term in data or
                search_term in caminho
            ):
        ...
        self.status_var.set(
            f"{len(filtered)} itens Encontrados"
        )
    ...
    def populate_tree(self, items):
        ...
        total_size = sum(
            item["tamanho"] for item in items
        )
    ...
    def save_txt(self):
        ...
        try:
            ...
            with open(
                ...
                f.write(
                    "RELATÓRIO DE ARQUIVOS E PASTAS\n"
                )
    ...
    def _open_item(self, open_folder=False):
        ...
        try:
            ...
            target = (
                ...
                if open_folder and os.path.isfile(path)
                else path
            )
