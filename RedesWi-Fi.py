...
entrada_rede = tk.Entry(janela, width=50,font=('TkDefaultFont', 11, 'bold'))
entrada_rede.pack()
...
botao_usuarios = tk.Button(janela, text="Exibir Usuários Conectados", command=exibir_usuarios_conectados, bg="#1bf0f7")
...
texto_resultado.config(yscrollcommand=scrollbar.set, font=('TkDefaultFont', 11, 'bold'))
