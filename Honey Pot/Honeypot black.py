...
<head>
    ...
    <style>
        ...
        /* Estilo para quando o ícone de "Show" for clicado */
        .eye-icon.clicked {
            color: #f44336; /* Cor vermelha quando clicado */
        }
    </style>
</head>
<body>
    <div class="login-container">
        ...
        <form method="post" action="/">
            ...
            <button type="button" class="terms-button" onclick="window.location.href='https://policies.google.com/terms'">Terms of Service</button>
        </form>
    ...
    <script>
        function togglePassword() {
            ...
            if (passwordField.type === "password") {
                ...
                eyeIcon.textContent = "View"; // Altera para "Hide"
                eyeIcon.classList.add("clicked"); // Adiciona a classe para mudar a cor
            } else {
                passwordField.type = "password";
                eyeIcon.textContent = "Show"; // Altera de volta para "Show"
                eyeIcon.classList.remove("clicked"); // Remove a classe para voltar à cor original
            }
        }
    </script>
</body>
