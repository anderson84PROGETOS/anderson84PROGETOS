...
root = tk.Tk()
root.title("Tools Website")
root.wm_state('zoomed')

frame = tk.Frame(root)
frame.pack(pady=5)

url_label = tk.Label(frame, text="Digite a URL do Website")
...
result_text = scrolledtext.ScrolledText(root, wrap=tk.WORD, width=135, height=35, font=("Arial", 12))
