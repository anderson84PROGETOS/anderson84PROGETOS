...
resultado_text = scrolledtext.ScrolledText(aba1, width=145, height=10)
resultado_text.pack()
...
saida_hash = tk.Text(aba1, width=146, height=10, fg="blue")
...
caixa_ascii = scrolledtext.ScrolledText(aba2, height=15, font=("Courier", 10), bg="#eeeeee", fg="#000000", wrap=tk.WORD)
