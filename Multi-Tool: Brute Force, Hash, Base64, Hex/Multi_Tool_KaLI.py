...
resultado_text = scrolledtext.ScrolledText(aba1, width=145, height=8)
resultado_text.pack()
...
caixa_hex = scrolledtext.ScrolledText(aba2, height=12, font=("Courier", 10), bg="#ffffff", fg="#000000", wrap=tk.WORD)
caixa_hex.pack(fill="both", padx=10, pady=5, expand=False)
tk.Label(aba2, text="Assinatura em Base64", font=("Arial", 11, "bold")).pack()
caixa_base64 = scrolledtext.ScrolledText(aba2, height=12, font=("Courier", 10), bg="#eeeeee", fg="#000000", wrap=tk.WORD)
...
input_text_base64 = tk.Text(aba3, width=120, height=20)
...
entrada_texto_hex = tk.Text(frame_entrada_hex, width=115, height=5, font=("Arial", 12))
...
texto_resultado_hex = tk.Text(frame_resultado_hex, width=130, height=5, wrap=tk.WORD, yscrollcommand=scrollbar_hex.set, font=("Courier", 10), fg="green")
...
hex_viewer = tk.Text(frame_hex_viewer, wrap=tk.NONE, width=130, height=5, font=("Courier", 10), yscrollcommand=scroll_hex_viewer.set)
...
hex_texto_entrada = tk.Text(frame_hex_texto, wrap=tk.WORD, width=130, height=5, font=("Courier", 10), yscrollcommand=scroll_hex_texto.set)
...
texto_decodificado = tk.Text(frame_texto_decodificado, wrap=tk.WORD, width=130, height=5, font=("Courier", 10), fg="green", yscrollcommand=scroll_texto_decodificado.set)
